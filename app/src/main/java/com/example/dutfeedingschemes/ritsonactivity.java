...
public class ritsonactivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ritsonactivity);
        ...
        btnView1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(res.getCount()==0){
                    Toast.makeText(ritsonactivity.this, "No Entry Exists", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(ritsonactivity.this);
